...
def HEIDEN_Arc(
    ...
    print("skip CC print");
    print(round(MACHINE_LAST_CENTER["X"],3));
    print(round(H_Arc_CC["X"],3));
    print(round(MACHINE_LAST_CENTER["Y"],3));
    print(round(H_Arc_CC["Y"],3));
    if (
        round(MACHINE_LAST_CENTER["X"],3) == round(H_Arc_CC["X"],3)
        and round(MACHINE_LAST_CENTER["Y"],3) == round(H_Arc_CC["Y"],3)
        and round(MACHINE_LAST_CENTER["Z"],3) == round(H_Arc_CC["Z"],3)
    ):
        H_ArcSameCenter = True
        print("skip CC print True");
