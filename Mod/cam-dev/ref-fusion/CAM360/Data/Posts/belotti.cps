...
deprecatedDescription = "This post has been deprecated. Use the generic Fanuc post and the correct machine configuration instead.";
...
wcsDefinitions = {
  ...
  wcs          : [
    ...
    {name:"Extended", format:"G", range:[110, 129]},
    {name:"Extra", format:"G154 P", range:[21, 99]}
  ]
};
