...
var secFormat = createFormat({decimals:2, type:FORMAT_REAL}); // seconds - range 0.01-1000
...
var settings = {
  ...
  programNumber               : {min:1, max:65536}, // specifies the program number range and reserved numbers
...
function onOpen() {
  ...
  writeln("\u0011");
  writeln(":" + oFormat.format(getProgramNumber()) + ";");
