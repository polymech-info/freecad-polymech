...
var secFormat = createFormat({decimals:2, type:FORMAT_REAL}); // seconds - range 0.01-99.99
...
var settings = {
  ...
  programNumber               : {reserved:[9000, 99999999]}, // specifies the program number range and reserved numbers
...
function onOpen() {
  ...
  writeln("%" + getProgramNumber() + conditional(programComment, " " + formatComment(programComment)));
  writeProgramHeader();
