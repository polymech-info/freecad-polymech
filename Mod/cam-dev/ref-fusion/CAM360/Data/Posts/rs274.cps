/**
  ...
  $Revision: 45631 a3aa5eb6e253b99fdf69fc12c12e55108bd560d4 $
  $Date: 2025-10-15 18:43:46 $
...
function onOpen() {
  ...
  writeBlock(gAbsIncModal.format(90), gFeedModeModal.format(94), gFormat.format(40), gFormat.format(80));
