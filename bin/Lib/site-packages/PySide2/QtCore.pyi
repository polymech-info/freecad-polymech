...
class QAbstractEventDispatcher(PySide2.QtCore.QObject):
    ...
    def filterNativeEvent(self, eventType: PySide2.QtCore.QByteArray, message: int) -> typing.Tuple[bool, int]: ...
    def flush(self) -> None: ...
...
class QAbstractItemModel(PySide2.QtCore.QObject):
    ...
    def encodeData(self, indexes: typing.List[int], stream: PySide2.QtCore.QDataStream) -> None: ...
...
class QAbstractNativeEventFilter(Shiboken.Object):
    ...
    def nativeEventFilter(self, eventType: PySide2.QtCore.QByteArray, message: int) -> typing.Tuple[bool, int]: ...
...
class QAbstractTransition(PySide2.QtCore.QObject):
    ...
    def setTargetStates(self, targets: typing.Sequence[PySide2.QtCore.QAbstractState]) -> None: ...
...
class QByteArray(Shiboken.Object):
    ...
    def size(self) -> int: ...
    def split(self, sep: int) -> typing.List[PySide2.QtCore.QByteArray]: ...
...
class QCborArray(Shiboken.Object):
    ...
    @staticmethod
    def fromStringList(list: typing.Sequence[str]) -> PySide2.QtCore.QCborArray: ...
    @staticmethod
    def fromVariantList(list: typing.Sequence[typing.Any]) -> PySide2.QtCore.QCborArray: ...
...
class QCborMap(Shiboken.Object):
    ...
    @staticmethod
    def fromVariantHash(hash: typing.Dict[str, typing.Any]) -> PySide2.QtCore.QCborMap: ...
    @staticmethod
    def fromVariantMap(map: typing.Dict[str, typing.Any]) -> PySide2.QtCore.QCborMap: ...
    def isEmpty(self) -> bool: ...
...
class QCommandLineParser(Shiboken.Object):
    ...
    def addOptions(self, options: typing.Sequence[PySide2.QtCore.QCommandLineOption]) -> bool: ...
...
class QConcatenateTablesProxyModel(PySide2.QtCore.QAbstractItemModel):
    ...
    def headerData(self, section: int, orientation: PySide2.QtCore.Qt.Orientation, role: int = ...) -> typing.Any: ...
    def index(self, row: int, column: int, parent: PySide2.QtCore.QModelIndex = ...) -> PySide2.QtCore.QModelIndex: ...
    def itemData(self, proxyIndex: PySide2.QtCore.QModelIndex) -> typing.Dict[int, typing.Any]: ...
    def mapFromSource(self, sourceIndex: PySide2.QtCore.QModelIndex) -> PySide2.QtCore.QModelIndex: ...
    def mapToSource(self, proxyIndex: PySide2.QtCore.QModelIndex) -> PySide2.QtCore.QModelIndex: ...
    def mimeData(self, indexes: typing.List[int]) -> PySide2.QtCore.QMimeData: ...
    def mimeTypes(self) -> typing.List[str]: ...
    ...
    def setData(self, index: PySide2.QtCore.QModelIndex, value: typing.Any, role: int = ...) -> bool: ...
    def setItemData(self, index: PySide2.QtCore.QModelIndex, roles: typing.Dict[int, typing.Any]) -> bool: ...
    def sourceModels(self) -> typing.List[PySide2.QtCore.QAbstractItemModel]: ...
    def span(self, index: PySide2.QtCore.QModelIndex) -> PySide2.QtCore.QSize: ...
...
class QDir(Shiboken.Object):
    ...
    @typing.overload
    def entryInfoList(self, nameFilters: typing.Sequence[str], filters: PySide2.QtCore.QDir.Filters = ..., sort: PySide2.QtCore.QDir.SortFlags = ...) -> typing.List[PySide2.QtCore.QFileInfo]: ...
    @typing.overload
    def entryList(self, filters: PySide2.QtCore.QDir.Filters = ..., sort: PySide2.QtCore.QDir.SortFlags = ...) -> typing.List[str]: ...
    @typing.overload
    def entryList(self, nameFilters: typing.Sequence[str], filters: PySide2.QtCore.QDir.Filters = ..., sort: PySide2.QtCore.QDir.SortFlags = ...) -> typing.List[str]: ...
    @typing.overload
...
class QItemSelection(Shiboken.Object):
    ...
    def __add__(self, l: typing.Sequence[PySide2.QtCore.QItemSelectionRange]) -> typing.List[PySide2.QtCore.QItemSelectionRange]: ...
    @staticmethod
    def __copy__() -> None: ...
    @typing.overload
    def __iadd__(self, l: typing.Sequence[PySide2.QtCore.QItemSelectionRange]) -> typing.List[PySide2.QtCore.QItemSelectionRange]: ...
    @typing.overload
    def __iadd__(self, t: PySide2.QtCore.QItemSelectionRange) -> typing.List[PySide2.QtCore.QItemSelectionRange]: ...
    @typing.overload
    def __lshift__(self, l: typing.Sequence[PySide2.QtCore.QItemSelectionRange]) -> typing.List[PySide2.QtCore.QItemSelectionRange]: ...
    @typing.overload
    ...
    @typing.overload
    def append(self, t: typing.Sequence[PySide2.QtCore.QItemSelectionRange]) -> None: ...
    ...
    def isEmpty(self) -> bool: ...
    def isSharedWith(self, other: typing.Sequence[PySide2.QtCore.QItemSelectionRange]) -> bool: ...
    ...
    @typing.overload
    def swap(self, other: typing.Sequence[PySide2.QtCore.QItemSelectionRange]) -> None: ...
...
class QJsonArray(Shiboken.Object):
    ...
    @staticmethod
    def fromStringList(list: typing.Sequence[str]) -> PySide2.QtCore.QJsonArray: ...
    @staticmethod
    def fromVariantList(list: typing.Sequence[typing.Any]) -> PySide2.QtCore.QJsonArray: ...
...
class QJsonDocument(Shiboken.Object):
    ...
    def setObject(self, object: typing.Dict[str, PySide2.QtCore.QJsonValue]) -> None: ...
...
class QMimeData(PySide2.QtCore.QObject):
    ...
    def setUrls(self, urls: typing.Sequence[PySide2.QtCore.QUrl]) -> None: ...
    def text(self) -> str: ...
...
class QProcess(PySide2.QtCore.QIODevice):
    ...
    @typing.overload
    def start(self, program: str, arguments: typing.Sequence[str], mode: PySide2.QtCore.QIODevice.OpenMode = ...) -> None: ...
    @typing.overload
    @staticmethod
...
class QSysInfo(Shiboken.Object):
    ...
    class WinVersion(Shiboken.Enum):
        WV_None                  : QSysInfo.WinVersion = ... # 0x0
        WV_32s                   : QSysInfo.WinVersion = ... # 0x1
        WV_95                    : QSysInfo.WinVersion = ... # 0x2
        WV_98                    : QSysInfo.WinVersion = ... # 0x3
...
class QUrl(Shiboken.Object):
    ...
    @staticmethod
    def fromStringList(uris: typing.Sequence[str], mode: PySide2.QtCore.QUrl.ParsingMode = ...) -> typing.List[PySide2.QtCore.QUrl]: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def toStringList(uris: typing.Sequence[PySide2.QtCore.QUrl], options: PySide2.QtCore.QUrl.FormattingOptions = ...) -> typing.List[str]: ...
...
class QUrlQuery(Shiboken.Object):
    ...
    def queryItems(self, encoding: PySide2.QtCore.QUrl.ComponentFormattingOption = ...) -> typing.List[typing.Tuple[str, str]]: ...
...
class QVersionNumber(Shiboken.Object):
    ...
    @staticmethod
    def fromString(string: str) -> typing.Tuple[PySide2.QtCore.QVersionNumber, int]: ...
...
class QXmlStreamAttributes(Shiboken.Object):
    ...
    def swap(self, other: typing.List[PySide2.QtCore.QXmlStreamAttribute]) -> None: ...
    def swapItemsAt(self, i: int, j: int) -> None: ...
...
class QXmlStreamReader(Shiboken.Object):
    ...
    def addExtraNamespaceDeclarations(self, extraNamespaceDeclaractions: typing.List[PySide2.QtCore.QXmlStreamNamespaceDeclaration]) -> None: ...
    def atEnd(self) -> bool: ...
