...
class QSslCertificate(Shiboken.Object):
    ...
    def subjectAlternativeNames(self) -> typing.OrderedDict[PySide2.QtNetwork.QSsl.AlternativeNameEntryType, typing.List[str]]: ...
...
class QSslSocket(PySide2.QtNetwork.QTcpSocket):
    ...
    def close(self) -> None: ...
    @typing.overload
    def connectToHostEncrypted(self, hostName: str, port: int, mode: PySide2.QtCore.QIODevice.OpenMode = ...) -> None: ...
    @typing.overload
    def connectToHostEncrypted(self, hostName: str, port: int, sslPeerName: str, mode: PySide2.QtCore.QIODevice.OpenMode = ...) -> None: ...
    @staticmethod
...
class QUdpSocket(PySide2.QtNetwork.QAbstractSocket):
    ...
    def readDatagram(self, data: bytes, maxlen: int, host: PySide2.QtNetwork.QHostAddress) -> typing.Tuple[int, int]: ...
