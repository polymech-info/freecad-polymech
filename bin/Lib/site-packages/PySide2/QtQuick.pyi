...
class QQuickWindow(PySide2.QtGui.QWindow):
    ...
    class NativeObjectType(Shiboken.Enum):
        NativeObjectTexture      : QQuickWindow.NativeObjectType = ... # 0x0
    ...
    def rendererInterface(self) -> PySide2.QtQuick.QSGRendererInterface: ...
    ...
    @typing.overload
    @staticmethod
    def setSceneGraphBackend(api: PySide2.QtQuick.QSGRendererInterface.GraphicsApi) -> None: ...
    @typing.overload
    @staticmethod
...
class QSGAbstractRenderer(PySide2.QtCore.QObject):
    ...
    class ClearModeBit(Shiboken.Enum):
        ClearColorBuffer         : QSGAbstractRenderer.ClearModeBit = ... # 0x1
        ClearDepthBuffer         : QSGAbstractRenderer.ClearModeBit = ... # 0x2
        ClearStencilBuffer       : QSGAbstractRenderer.ClearModeBit = ... # 0x4

    class MatrixTransformFlag(Shiboken.Enum):
        MatrixTransformFlipY     : QSGAbstractRenderer.MatrixTransformFlag = ... # 0x1
...
class QSGRendererInterface(Shiboken.Object):
    ...
    OpenGL                   : QSGRendererInterface.GraphicsApi = ... # 0x2
    Direct3D12               : QSGRendererInterface.GraphicsApi = ... # 0x3
    OpenVG                   : QSGRendererInterface.GraphicsApi = ... # 0x4
    OpenGLRhi                : QSGRendererInterface.GraphicsApi = ... # 0x5
    Direct3D11Rhi            : QSGRendererInterface.GraphicsApi = ... # 0x6
    VulkanRhi                : QSGRendererInterface.GraphicsApi = ... # 0x7
    MetalRhi                 : QSGRendererInterface.GraphicsApi = ... # 0x8
    NullRhi                  : QSGRendererInterface.GraphicsApi = ... # 0x9
    ...
    PhysicalDeviceResource   : QSGRendererInterface.Resource = ... # 0x5
    OpenGLContextResource    : QSGRendererInterface.Resource = ... # 0x6
    DeviceContextResource    : QSGRendererInterface.Resource = ... # 0x7
    CommandEncoderResource   : QSGRendererInterface.Resource = ... # 0x8
    VulkanInstanceResource   : QSGRendererInterface.Resource = ... # 0x9
    RenderPassResource       : QSGRendererInterface.Resource = ... # 0xa
    ...
    @typing.overload
    def getResource(self, window: PySide2.QtQuick.QQuickWindow, resource: PySide2.QtQuick.QSGRendererInterface.Resource) -> int: ...
    @typing.overload
    def getResource(self, window: PySide2.QtQuick.QQuickWindow, resource: bytes) -> int: ...
    def graphicsApi(self) -> PySide2.QtQuick.QSGRendererInterface.GraphicsApi: ...
    @staticmethod
    def isApiRhiBased(api: PySide2.QtQuick.QSGRendererInterface.GraphicsApi) -> bool: ...
    def shaderCompilationType(self) -> PySide2.QtQuick.QSGRendererInterface.ShaderCompilationTypes: ...
    def shaderSourceType(self) -> PySide2.QtQuick.QSGRendererInterface.ShaderSourceTypes: ...
    def shaderType(self) -> PySide2.QtQuick.QSGRendererInterface.ShaderType: ...
