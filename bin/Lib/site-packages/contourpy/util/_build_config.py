...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"FreeCAD_env/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"D:/bld/contourpy_1754063564178/work/builddir/lib/contourpy/util",
        source_dir=r"D:/bld/contourpy_1754063564178/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=D:/bld/contourpy_1754063564178/work/builddir/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
